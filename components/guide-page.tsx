      ...
      <main className="bg-background text-foreground">
        <article>
          <header className="bg-[image:var(--hero-gradient)] px-4 py-14 sm:px-6 md:py-20">
            <div className="mx-auto max-w-4xl">
              ...
              <h1 className="mt-4 text-4xl font-semibold tracking-tight text-balance md:text-6xl">{title}</h1>
              ...
              <p className="mt-4 text-xs leading-5 text-muted-foreground">
                Reviewed July 2026. {config.affiliateDisclosure} Results vary; this guide does not guarantee sales or income.
              </p>
            </div>
          </header>
        ...
        <section className="border-y border-border bg-muted/55 px-4 py-14 sm:px-6 md:py-20">
          <div className="mx-auto max-w-5xl">
            <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">Related beginner guides</h2>
        ...
        <section className="bg-foreground px-4 py-14 text-background sm:px-6 md:py-20 dark:bg-card dark:text-card-foreground">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-semibold tracking-tight text-balance md:text-4xl">{ctaTitle}</h2>
            <p className="mt-4 text-base leading-7 text-background/75 dark:text-muted-foreground">{ctaText}</p>
